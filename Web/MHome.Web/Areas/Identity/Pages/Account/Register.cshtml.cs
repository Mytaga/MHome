...
namespace MHome.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///
            [Required]
            [MinLength(ClientValidationConstants.FirstNameMinLength)]
            [MaxLength(ClientValidationConstants.FirstNameMaxLength)]
            public string FirstName { get; set; }

            [Required]
            [MinLength(ClientValidationConstants.LastNameMinLength)]
