    ...
    public partial class InitializeDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderedAccesorriesId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    OrdersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessoryOrder", x => new { x.OrderedAccesorriesId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_AccessoryOrder_Accessories_OrderedAccesorriesId",
                        column: x => x.OrderedAccesorriesId,
                        principalTable: "Accessories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccessoryOrder_Orders_OrdersId",
                        column: x => x.OrdersId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderedFurnitureId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    OrdersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FurnitureOrder", x => new { x.OrderedFurnitureId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_FurnitureOrder_Furnitures_OrderedFurnitureId",
                        column: x => x.OrderedFurnitureId,
                        principalTable: "Furnitures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FurnitureOrder_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccessoriesForSaleId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StoresId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessoryStore", x => new { x.AccessoriesForSaleId, x.StoresId });
                    table.ForeignKey(
                        name: "FK_AccessoryStore_Accessories_AccessoriesForSaleId",
                        column: x => x.AccessoriesForSaleId,
                        principalTable: "Accessories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FurnitureForSaleId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StoresId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FurnitureStore", x => new { x.FurnitureForSaleId, x.StoresId });
                    table.ForeignKey(
                        name: "FK_FurnitureStore_Furnitures_FurnitureForSaleId",
                        column: x => x.FurnitureForSaleId,
                        principalTable: "Furnitures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FurnitureStore_Stores_StoresId",
                        column: x => x.StoresId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessoryOrder_OrdersId",
                table: "AccessoryOrder",
                column: "OrdersId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessoryStore_StoresId",
                table: "AccessoryStore",
                column: "StoresId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FurnitureOrder_OrdersId",
                table: "FurnitureOrder",
                column: "OrdersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FurnitureStore_StoresId",
                table: "FurnitureStore",
                column: "StoresId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AccessoryStore_Stores_StoresId",
                table: "AccessoryStore",
                column: "StoresId",
                principalTable: "Stores",
                principalColumn: "Id",
